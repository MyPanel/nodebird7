...
document.getElementById('#loginButton').addEventListener('submit',function(element){
    var id=document.querySelector('#user_id').textContent;
    var name=document.querySelector('#user_name').textContent;
    var passwd=document.querySelector('#user_passwd').textContent;
    if(!id) {
        alert('id를 입력하세요.');
    }
    if(!name) {
